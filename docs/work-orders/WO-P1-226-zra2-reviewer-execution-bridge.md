...
- Repair R1 2026-09-13 (claim WO-P1-226-REPAIR-R1-GLM-001, comment 5649620105): R3 P1 closed @609a878 — read-only admission replay now cross-binds plan provider/execution/batch/expected-generation before release/handoff; wrong batch/generation => typed recovery, admission+lease retained, no handoff, zero new rows; exact identity replay cleans up once. RED-vs-78ec598 evidence + focused 38/38 + related 353. See docs/work-orders/WO-P1-226-repair-r1-admission-replay-binding.md.

- Combined R1 completion 2026-09-13: packet was amended (e5d7a27) to include Astra AF1-AF4; interim 609a878 covered only the admission binding. Final candidate `cc398d6b1bff329d7145d0a98662add108b423ab` closes AF1 (EXECUTING-job loser retains winner resources; REVIEW_WINNER_ACTIVE), AF2 (terminal-unusable reconcile releases once, no handoff/relaunch), AF3 (post-run full identity/worker classifier), AF4 (canonical provider-policy gate in the pure plan). REDs vs 609a878 in runs/WO-P1-226/red-af1-af4.txt; focused 42/42; full battery 2900.
