...
เวอร์ชันล่าสุด: 2026-08-22 (v0.4.3) · ระบบปฏิบัติการที่รองรับ: **Windows 10/11** (ฟีเจอร์เต็ม) · Python 3.11+ (ถ้าติดตั้งแบบนักพัฒนา)
...
มุมขวาบนมีปุ่ม **คู่มือ** — เปิดคู่มือฉบับนี้ได้ทันทีจากในโปรแกรม (ไม่มีคีย์ลัดที่ต้องจำ ทุกอย่างกดปุ่มได้เลย) และปุ่ม **ตั้งค่า** มีสวิตช์ **ภาษา / Language** สำหรับสลับไทย ↔ English (บันทึกทันที มีผลเต็มเมื่อปิด-เปิดโปรแกรมใหม่) ชื่อหน้าต่างโปรแกรมแสดงเลขเวอร์ชันเสมอ เช่น `A-Sunday Conductor v0.4.3` เพื่อยืนยันว่าเปิดตัวล่าสุด สวิตช์ **ปิดโปรแกรมแล้วหยุดทุกตัวเชื่อม** (เปิดไว้เป็นค่าเริ่มต้น) จะสั่งหยุดตัวเชื่อมทุกตัวและเก็บกวาด process ค้างให้ตอนปิดหน้าต่าง — เครื่องเคลียร์เสมอ
