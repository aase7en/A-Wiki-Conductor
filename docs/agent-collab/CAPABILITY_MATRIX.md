...
- WO-P1-115 repaired head `cf9676a6d4b9ce988f849426d514a823df034d18` safely bootstraps provider tables and adds atomic provider-global admission in the existing SQLite provider authority; independent GLM review found zero P0/P1/P2 defects, and GPT repaired two quota-evidence P3 hardening findings. Installed-DB-copy E2E preserved all 12 existing tables and did not mutate the live DB.
