...
|---|---|---|---|---|
| Integrator | GPT-5.6 Sol | WO-P1-115 / AHA-6A.1 | provider admission/runtime wiring + tests + bounded SSoT | CLAIMED / PLAN_GATE |
| GLM review lane | GLM-5.3 MAX via one-way file bridge until automatic dispatch proves ready | future `wo115-glm-review-*` | read-only result artifact only | PREPARED |
