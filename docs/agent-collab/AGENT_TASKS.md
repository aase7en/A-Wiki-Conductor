...
|---|---|---|---|---|
| Integrator | GPT-5.6 Sol | WO-P1-115 / AHA-6A.1 | provider admission/runtime wiring + tests + bounded SSoT | IMPLEMENTED / REVIEW_GATE |
| GLM review lane | GLM-5.3 MAX via one-way file bridge until automatic dispatch proves ready | `wo115-glm-review-001` | read-only `runs/wo115-glm-review-001/result.json` only | PREPARED / EXACT-SHA PACKET NEXT |
