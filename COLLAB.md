...
|---|---|---|---|
| `WO-P1-036` | ChatGPT / Sunday-Conducter | 2026-08-20 | `src/a_conductor/native_operations.py`, `src/a_conductor/__init__.py`, `tests/test_native_operations.py`, `docs/contracts/native-operation-registry.md`, `COLLAB.md`, `CURRENT-WORK.md`, `handoff.md`, `docs/work-orders/WO-P1-036-native-operation-registry.md` |
