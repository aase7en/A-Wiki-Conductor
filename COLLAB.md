...
- `WO-P1-148` AIP-1 pure service-authorization contract: semantic Terms identity hardening plus chronology binding now require authorization evidence to be observed on/after the declared Terms effective date. RED `72592db...`; repair `b8771e3e...`; focused 46/46 + provider regression 246/246 PASS. No live/store/policy/admission/runtime mutation. Prior `e4e41c0...` CI/review evidence is stale; fresh exact-SHA CI/review required.
