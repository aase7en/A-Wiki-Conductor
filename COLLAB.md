...
|---|---|---|---|
| `WO-P1-032` | ChatGPT / Sunday-Conducter | 2026-08-20 | `src/a_conductor/native_adapters.py`, `src/a_conductor/__init__.py`, `tests/test_native_adapters.py`, `docs/contracts/native-execution-adapters.md`, `COLLAB.md`, `CURRENT-WORK.md`, `handoff.md`, `docs/work-orders/WO-P1-032-native-git-verification-adapters.md` |
