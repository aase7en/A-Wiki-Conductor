...
|---|---|---|---|
| `WO-AC-RES-007` | ChatGPT / Sunday-Conducter | 2026-08-20 | `src/a_conductor/fault_injection.py`, `src/a_conductor/__init__.py`, `tests/test_resilient_fault_injection.py`, `docs/contracts/fault-injection.md`, `COLLAB.md`, `CURRENT-WORK.md`, `handoff.md`, `docs/work-orders/WO-AC-RES-007-fault-injection.md` |
