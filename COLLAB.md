...
|---|---|---|---|
| `WO-P1-151` service/Terms authorization binding | GPT-5.6 Sol MAX | CLAIMED 2026-09-03 | `provider_service_authorization.py`, focused tests, WO151, bounded `COLLAB.md`; pure/no-I/O only; no store/policy/runtime/live AiPASS. |
