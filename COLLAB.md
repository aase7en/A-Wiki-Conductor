...
|---|---|---|---|
| `WO-P1-001` | ChatGPT / Sunday-Conducter | 2026-08-20 | `pyproject.toml`, `src/a_conductor/**`, `tests/test_domain.py`, `COLLAB.md`, `CURRENT-WORK.md`, `handoff.md`, `docs/work-orders/WO-P1-001-domain-models.md` |
