...
1. ดาวน์โหลด **`A-Sunday.Conductor.exe`** (ชื่อไฟล์จริงของ Portable — GitHub แสดงช่องว่างเป็นจุด)
...
### C. เลือกภาษา (ไทย / 中文 / English)

1. กดปุ่ม **[Settings/ตั้งค่า]** มุมขวาบน
2. เลือก **ภาษา / Language** (3 ภาษา — คำอธิบายเปลี่ยนทันที ไม่ต้องปิด-เปิดใหม่; ป้ายปุ่มคงเป็นภาษาอังกฤษตามมาตรฐาน)
